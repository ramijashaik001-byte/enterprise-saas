...
class SurveyPolicyConfig_1(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_2(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_3(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_4(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_5(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_6(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_7(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_8(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_9(BaseModel):
    policy_id: int
...
class SurveyPolicyConfig_10(BaseModel):
    policy_id: int
