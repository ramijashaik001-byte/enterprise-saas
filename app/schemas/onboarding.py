...
class OnboardingTaskUpdate(BaseModel):
    ...
    due_date: Optional[Optional[date]] = None
...
class OnboardingTaskPolicyConfig_1(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_2(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_3(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_4(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_5(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_6(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_7(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_8(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_9(BaseModel):
    policy_id: int
...
class OnboardingTaskPolicyConfig_10(BaseModel):
    policy_id: int
