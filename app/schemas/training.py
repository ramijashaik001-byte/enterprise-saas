...
class TrainingCourseUpdate(BaseModel):
    ...
    max_participants: Optional[Optional[int]] = None
...
class TrainingCoursePolicyConfig_1(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_2(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_3(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_4(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_5(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_6(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_7(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_8(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_9(BaseModel):
    policy_id: int
...
class TrainingCoursePolicyConfig_10(BaseModel):
    policy_id: int
